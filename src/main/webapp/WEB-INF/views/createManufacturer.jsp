<%@ page import="com.taxi.model.Manufacturer" %>
<%@ page import="com.taxi.services.interfaces.ManufacturerService" %>
...
<section>
  <h2>Please, create a manufacturer:</h2>
  <form method="post" action="ManufacturerController">
  <div class="input-section">
    <div class="input-container">
      <label class="input-label" for="manufName">Name:</label>
      <input class="input-field" type="text" name="name" id="manufName" />
    </div>
    <div class="input-container">
      <label class="input-label" for="manufCountry">Country:</label>
      <input class="input-field" type="text" name="country" id="manufCountry" />
    </div>
