...
<section>
    <h2>Please, create a driver:</h2>
    <form method="post" action="DriverController">
        <div class="input-section">
            <div class="input-container">
                <label class="input-label" for="driverName">Name:</label>
                <input class="input-field" type="text" name="name" id="driverName" />
            </div>
            <div class="input-container">
                <label class="input-label" for="driverLicenceNumber">License Number:</label>
                <input class="input-field" type="text" name="licenceNumber" id="driverLicenceNumber" />
            </div>
